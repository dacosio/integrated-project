  ...
  return (
    <Link
      ...
      state={{
        ...
        splitteeName: order.splitteeName,
        splitterName: order.splitterName,
        imageUrl: order.imageUrl,
        latitude: order.latitude,
        longitude: order.longitude,
        meetUpAddress: order.meetupAddress,
        meetUpInfo: order.meetupSchedule,
        name: order.name,
        price: order.price,
        qty: order.qty,
        splitteeName: order.splitteeName,
        splitteeContactNumber: order.splitteeContactNumber,
        splitteeImageURL: order.splitteeImageURL,
        splitteeEmail: order.splitteeEmail,
      }}
    >
      <div style={{ backgroundColor: "var(--bg-gray)", minHeight: "100vh" }}>
        <div className={styles.backButtonWrapper}>
          <BackButton onClick={() => navigate("/transaction")} />
        </div>
        ...
        {isDesktop ? (
          ...
          <div
            style={{ minHeight: "100vh", backgroundColor: "var(--bg-gray)" }}
          >
            {order && (
